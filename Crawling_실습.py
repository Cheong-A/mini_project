...
#엑셀로 저장하기 위한 변수
RESULT_PATH ='C:/Users/blue_/Downloads/fast/news_data/'  #결과 저장할 경로
...
def crawler(maxpage,query,sort,s_date,e_date):
    ...
    while page <= maxpage_t:
        ...
        #네이버 검색/ 어디서?=뉴스탭= query(검색어의미)+ 정렬방법 +날짜+날짜+
        ...
        #모든 리스트 딕셔너리형태로 저장
        result= {"title":title_text ,  "언론사" : source_text ,"contents": contents_text ,"link":link_text }
